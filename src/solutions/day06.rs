...
pub fn parse(input: &str) -> (Vec<Vec<u64>>, Vec<Vec<String>>, Vec<char>) {
    ...
    let mut problems2: Vec<_> = problems_length
        ...
        .map(|&n| {
            ...
            //   [ "", "", "" ], [ "", "", "" ], ...
            let mut problem = Vec::with_capacity(n);
            (0..n).for_each(|_| problem.push("".to_owned()));
            problem
        })
        .collect();
...
pub fn part1(worksheet: &(Vec<Vec<u64>>, Vec<Vec<String>>, Vec<char>)) -> u64 {
...
pub fn part2(worksheet: &(Vec<Vec<u64>>, Vec<Vec<String>>, Vec<char>)) -> u64 {
